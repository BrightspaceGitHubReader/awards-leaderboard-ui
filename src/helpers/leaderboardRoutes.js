...
export class LeaderboardRoutes {
	static ClasslistLeaderboard(orgUnitId, classlistSort) { return `/d2l/api/bas/${BAS_VERSION}/orgunits/${orgUnitId}/classlist/?limit=${MAX_USERS}&sortField=${classlistSort}&fetchLatest=true`; }
